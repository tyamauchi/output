...
# 制約条件
problem += 6 * theta - (3 * lambda1 + 5 * lambda2 + 6 * lambda3 + 3 * lambda4 + 2 * lambda5 + 16 * lambda6) >= 0, "Constraint 1"
problem += 3 * theta - (2 * lambda1 + 5 * lambda2 + 3 * lambda3 + 3 * lambda4 + 8 * lambda5 + 4 * lambda6) >= 0, "Constraint 2"
problem += 6 * lambda1 + 10 * lambda2 + 12 * lambda3 + 9 * lambda4 + 8 * lambda5 + 16 * lambda6 - 12 >= 0, "Constraint 3"
