...
# 制約条件
problem += 2 * theta - (2 * lambda1 + 3 * lambda2 + 4 * lambda3 +  2 * lambda4 + 1 * lambda5 + 1 * lambda6) >= 0, "Constraint 1"
problem += 3 * theta - (3 * lambda1 + 3 * lambda2 + 1 * lambda3 +  1 * lambda4 + 4 * lambda5 + 2 * lambda6) >= 0, "Constraint 2"
problem += 1 * lambda1 + 4 * lambda2 + 3 *   lambda3 + 1 * lambda4 + 3 * lambda5 + 2 * lambda6 - 1 >= 0, "Constraint 3"
problem += 3 * lambda1 + 2 * lambda2 + 1 *   lambda3 + 4 * lambda4 + 3 * lambda5 + 2 * lambda6 - 3 >= 0, "Constraint 4"
